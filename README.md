...
three-plan effort: see `notes/plan.md` (verbatim plan),
`notes/orchestration.md` (how brokkr drives us),
`notes/ratatoskr-client-surface.md` (what the JMAP client expects),
`notes/jmap-client-fork.md`, `notes/fixture-format.md`.

Status: bootstrap. No JMAP yet.
